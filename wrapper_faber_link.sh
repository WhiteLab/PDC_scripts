...
NOW=$(date +"%y%m%d")
cd /filestore/LOGS && ../PDC_scripts/fudge_it_PF.py -d /filestore/SFTP_SHARE/pfaber/pfaber_data -m FLOWCELLID -l /filestore/RSYNC_SHARE/faber_core_sync 2>> $NOW'_faber_link.log' >> $NOW'_faber_link.log' &
